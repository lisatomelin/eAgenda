...
namespace eAgenda.WinApp
{
    public partial class TelaPrincipalForm : Form
    {
        ...
        private readonly InjecaoDependencia injecaoDependencia;

        public TelaPrincipalForm(InjecaoDependencia injecaoDependencia)
        {
            InitializeComponent();
            ...
            this.injecaoDependencia = injecaoDependencia;
        }
        ...
        {
            ConfigurarTelaPrincipal(injecaoDependencia.Get<ControladorTarefa>());
        }

        private void contatosMenuItem_Click(object sender, EventArgs e)
        {
            ConfigurarTelaPrincipal(injecaoDependencia.Get<ControladorContato>());
        }

        private void compromissosMenuItem_Click(object sender, EventArgs e)
        {
            ConfigurarTelaPrincipal(injecaoDependencia.Get<ControladorCompromisso>());
        }

        private void despesasMenuItem_Click(object sender, EventArgs e)
        {
            ConfigurarTelaPrincipal(injecaoDependencia.Get<ControladorDespesa>());
        }

        private void categoriasMenuItem_Click(object sender, EventArgs e)
        {
            ConfigurarTelaPrincipal(injecaoDependencia.Get<ControladorCategoria>());
        }
